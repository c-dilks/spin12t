...
void Bin_Splitter()
{
  ...
  Double_t pt_low=0.0;
  Double_t pt_high=10.0; // can go up to 37, but pi0 reconstruction is unreliable for pT>15
  Int_t pt_bins=1;

  Double_t en_low=0.0;
  Double_t en_high=100; // can go up to 100, but cluster merging is problem for E>100
  Int_t en_bins=1;
